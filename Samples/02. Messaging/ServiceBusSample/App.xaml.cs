    ...
    public partial class App : ApplicationBase, IProvideLogString
    {
        ...
        private void ConfigureServices(IConfiguration configuration, IServiceCollection services)
        {
            ...
            services.AddSingleton<Window>((IServiceProvider provider) =>
            {
                ...
                //var resourceName = "pack://application:,,,/Common.PresentationBase;component/Resources/Images/Azure/iot/00039-icon-service-Event-Hubs.png";
