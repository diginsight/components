        ...
        public static void Main(string[] args)
        {
            ...
            var builder = CreateHostBuilder(args)
                          .ConfigureLogging((context, loggingBuilder) =>
                          {
                              ...
                              // if local => 
                              var traceLoggerProvider = default(TraceLoggerFormatProvider);
                              ...
                              if (traceLoggerConsoleProviderIsEnabled)
                              {
                                  ...
                                  traceLoggerProvider = new TraceLoggerFormatProvider(context.Configuration) { ConfigurationSuffix = "Console" };
                              ...
                              ok = bool.TryParse(log4NetProviderIsEnabledString, out var log4NetProviderIsEnabled);
