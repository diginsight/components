...
- [🏗️ Enhanced Configuration Hierarchy](#️-enhanced-configuration-hierarchy)
...
## 🏗️ Enhanced Configuration Hierarchy
...
- ✅ All standard .NET configuration features
...
/etc/myapp/config/
├── src/MyApp/Web/                    # Most specific
├── src/MyApp/                        # Less specific
├── src/                              # Less specific
└── /                                 # Least specific (root)
```
