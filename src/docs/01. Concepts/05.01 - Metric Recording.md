...
Metric recording provides **automatic capture of database operation costs**, enabling you to **identify expensive operations** and **optimize resource usage** across your application.

Following is an example diagrams for query_cost metric:
...
The metric recording is **strategic resource for cost management** that enables you to:
