...
//        {
//            using (var sec = TraceManager.GetCodeSection(T, new { client }))
//            {
...
//                    sec.Information($"getting user profile", "User");
//                    var userProfile = JsonConvert.DeserializeObject<UserProfile>(stringContent);
//                    return userProfile;
//                }
//            }
//            return null;
...
//        {
//            using (var sec = TraceManager.GetCodeSection(T, new { client, upn }))
//            {
//                // if (client == null) { client = HttpHelper.GetHttpClient("application/json", authResult.AccessToken)}
...
//                {
//                    var stringContent = await response.Content.ReadAsStringAsync();
//                    sec.Information($"getting user's manager", "User");
//                    var userProfile = JsonConvert.DeserializeObject<UserProfile>(stringContent);

//                    sec.Debug(new { userProfile = userProfile.GetLogString() });
//                    return userProfile;
//                }
//            }
//            return null;
...
//        {
//            using (var sec = TraceManager.GetCodeSection(T, new { client, groupName }))
//            {
...
//                {
//                    var stringContent = await response.Content.ReadAsStringAsync();
//                    sec.Information($"getting groupId", "groupName");
//                    var groupProfile = JsonConvert.DeserializeObject<GroupsProfile>(stringContent);
...
//                {
//                    var stringContent = await response.Content.ReadAsStringAsync();
//                    sec.Information($"getting belonging member fron distribution list, security group, etc, etc", "User");
//                    var membersGroup = JsonConvert.DeserializeObject<MembersGroup>(stringContent);
...
//        {
//            using (var sec = TraceManager.GetCodeSection(T, new { client, upn, groupName }))
//            {
//                bool isRevokerEnalbed = ConfigurationHelper.GetClassSetting<ProtectionControl, bool>(CONFIGVALUE_ISREVOKERENALBED, DEFAULTVALUE_ISREVOKERENALBED);
...
//                    {
//                        var stringContent = await response.Content.ReadAsStringAsync();
//                        sec.Information($"getting user's group in order to know if belong to declassifier group", "User");
//                        var memberOfGroups = JsonConvert.DeserializeObject<MemberGroups>(stringContent);
